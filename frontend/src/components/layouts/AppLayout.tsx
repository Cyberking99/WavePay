...
import { Home, Send, Link2, DollarSign, History, User, Menu, X, Building2, LogOut, RefreshCw, CandlestickChart } from "lucide-react";
...
const navigation = [
  ...
  { name: "Bank Accounts", href: ROUTES.BANK_ACCOUNTS, icon: Building2 },
  { name: "Swap", href: "/swap", icon: RefreshCw },
  { name: "Trade (Pro)", href: "/trade", icon: CandlestickChart },
